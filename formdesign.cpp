...
void FormDesign::buildItemPropertySelectionTeks(BaseAllItems *item)
{
    ...
    if (itm) {
      ...
      last_parent = insertNewPropertyItemFromParent(
          parent, ManyStructUiObjectParam::makePropertyItemSingleRow(
                      tr("Rotasi"), QIcon(), false, item->property ("rotasi").toInt (), QIcon(),
                      false, true));
    }
...
QStandardItem *FormDesign::insertNewPropertyItemFromParent(QStandardItem *parent, const ManyStructUiObjectParam::SingleRowPropertyParamItemEdit &in)
{
...
QStandardItem *FormDesign::lookUpSecondColumnPropItemFromKeyStringCol1(const QString &key)
{
